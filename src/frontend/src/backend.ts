...
export class Backend implements backendInterface {
    ...
    async addBlockEvaluation(arg0: string, arg1: bigint, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addBlockEvaluation(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addTriviaSession(arg0: string, arg1: bigint, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTriviaSession(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBlockEvaluations(): Promise<Array<BlockEvaluation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBlockEvaluations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllTriviaSessions(): Promise<Array<TriviaSession>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTriviaSessions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
