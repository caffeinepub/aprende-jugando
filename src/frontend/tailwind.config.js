  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        brand: {
          blue: "oklch(0.555 0.22 263)",
          "blue-light": "oklch(0.63 0.20 265)",
          orange: "oklch(0.72 0.195 47)",
          green: "oklch(0.60 0.18 145)",
          purple: "oklch(0.55 0.22 290)",
          pink: "oklch(0.60 0.20 320)",
          navy: "oklch(0.18 0.04 250)",
          bg: "oklch(0.962 0.018 220)",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        card: "0 4px 16px oklch(0.18 0.04 250 / 0.10)",
        "card-lg": "0 8px 32px oklch(0.18 0.04 250 / 0.14)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
